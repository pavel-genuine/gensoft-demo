    ...
    return (
        <div className='py-10 bg-[black] text-[white] px-[5vw]'>
                ...
                <div className=''>
                    ...
                    >
                        <div className='grid lg:grid-cols-3 gap-3  '>
                            ...
                            <Link href={'/'}><p className='lg:mr-10'>Products</p> </Link>
                            <Link href={'/'}><p>Gallery</p> </Link>
                            <Link href={'/'}><p>About Us</p> </Link>
                            <Link href={'/'}><p className='mb-10 lg:mb-0'>Contact Us</p> </Link>
                    ...
                    >
                        ...
                        <div className='grid lg:grid-cols-4 gap-3  '>
                            ...
                            <div>
                                ...
                                <p className='mt-3 font-thin'>
                                    <a className='underline' href="mailto:info@olympicbd.com">info@olympicbd.com</a>
                            ...
                            <div>
                                ...
                                <p className='mt-3 font-thin'>
                                    <a className='underline' href="tel:+88 02-223387485">+88 02-223387485 </a>
            ...
            <div className='text-[grey] lg:text-center mt-10 lg:px-4  '>
                <p className='mb-2'>
                    © 2023 Olympic all rights reserved.
                </p>
