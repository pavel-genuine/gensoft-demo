...
export function Menu({ toggle, isOpen }) {
    ...
    return (
        <nav style={{ zIndex: 10 }} className="  menuItem text-[white] ">
            <ul className={`${bgWhite ? ' bg-opacity-90 backdrop-blur-md text-center bg-[black] w-[120vw] pt-[10%] h-[110vh] mt-[-20px] ml-[-500px]' : ''}`}>
                ...
                <li className="li_menu" onClick={toggle}>
                    <Link className={`md:p-3 md:m-5 hover:text-nav ${router.pathname ==  "/" ? "border-b-[2px]" : ""}`} href= "/">Services</Link>

                </li>
                <li className="li_menu" onClick={toggle}>
                    <Link className={`md:p-3 md:m-5 hover:text-nav ${router.pathname == "/" ? "border-b-[2px]" : ""}`} href= "/">Products</Link>
                ...
                <li className="li_menu" onClick={toggle}>
                    <Link className={`md:p-3 md:m-5 hover:text-nav ${router.pathname ==  "/"? "border-b-[2px]" : ""}`} href= "/">About</Link>

                </li>

                <li className="li_menu" onClick={toggle}>
                    <Link className={`md:p-3 md:m-5 hover:text-nav ${router.pathname == "/"? "border-b-[2px]" : ""}`} href= "/">Contact</Link>
